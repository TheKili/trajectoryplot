...
devtools::load_all()
activeseqIplot::seqiplot(biofam.seq, margins = c(20,20,20,20), barWidth = 40, barHeight = 2, paddingInnerX = 0.01, tooltip = list(list( var=biofam$plingu02, label="Language"),list(var=biofam$birthyr, label="birthyear")), sortv = list(list(var=sort_lang,label="Sort by Language"), list(var=sort_year,label="Sort by year")), fisheye = list(d=10, a = 300, boundaries=200))
